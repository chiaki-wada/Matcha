//
//  GoidonYomiQuizViewController.swift
//  Matcha
//
...
class GoidonYomiQuizViewController: UIViewController, UITextFieldDelegate {
        ...
        if answer == shuffledAnswer {
            ...
            if currentQuestionIndex < shuffledQuestions.count - 1 {
                ...
                DispatchQueue.main.asyncAfter(deadline: .now() + 0.5) {
                    ...
                    let goidonQuizViewController = storyboard.instantiateViewController(withIdentifier: "GoidonQuizViewController") as! GoidonQuizViewController
                    self.navigationController?.pushViewController(goidonQuizViewController, animated: true)
                }
                return
            }
        } else {
