//
//  Minnichi1YomiQuizViewController.swift
//  Matcha
//
...
class Minnichi1YomiQuizViewController: UIViewController, UITextFieldDelegate {
            ...
            if answer == shuffledAnswer {
                ...
                if currentQuestionIndex < shuffledQuestions.count - 1 {
                    ...
                    DispatchQueue.main.asyncAfter(deadline: .now() + 0.5) {
                        ...
                        let minnichi1QuizViewController = storyboard.instantiateViewController(withIdentifier: "Minnichi1QuizViewController") as! Minnichi1QuizViewController
                        self.navigationController?.pushViewController(minnichi1QuizViewController, animated: true)
                    }
                    return
                }
            } else {
